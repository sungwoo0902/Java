...
public class EncapusleTest {
	...
	public static void main(String[] args) {
		...
		// Account 객체 생성 초기화
		Account kb = new Account("KB은행", "101-01-0101", "김유신", 10000);
		kb.deposit(40000);
		kb.withdraw(25000);
		kb.show();
		
		Account wr = new Account("우리은행", "101-02-0202", "이순신", 1000);
		wr.deposit(30000);
		wr.withdraw(5000);
		wr.show();
