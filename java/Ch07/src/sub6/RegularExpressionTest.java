...
public class RegularExpressionTest {
	...
	public static void main(String[] args) {
		...
		String ptt2 = "^[가-힣]*$"; // 이름 검증을 위한 정규표현식
		String ptt3 = "(01\\d{1})-(\\d{3,4})-(\\d{4})"; // 휴대폰 번호 검증을 위한 정규표현식
		String ptt4 = "(\\w+)@(\\w+).(\\w+)"; // 이메일 검증을 위한 정규표현식
		
		String str = "이름 : 홍길동, 휴대폰 : 010-1234-1001, 휴대폰 : 010-123-1001, 이메일 : hong@gmail.com";
